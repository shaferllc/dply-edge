...
class Cache extends Component
{
    ...
    public int $edgeTtl = 86400;

    public int $browserTtl = 86400;
    ...
    public function mount(Server $server, Site $site): void
    {
        ...
        $this->edgeTtl = (int) ($cfg['edge_ttl_seconds'] ?? 86400);
        $this->browserTtl = (int) ($cfg['browser_ttl_seconds'] ?? 86400);
    ...
    public function saveOptions(): void
    {
        ...
        $this->site->mergeEdgeMeta([
            'cache' => [
                'mode' => $this->mode,
                'edge_ttl_seconds' => $this->edgeTtl,
                'browser_ttl_seconds' => $this->browserTtl,
