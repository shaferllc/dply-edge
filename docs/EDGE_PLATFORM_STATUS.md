...
| Cost | Workers scale to zero; the scheduler wakes the app only when a task is due; new apps sleep after 5 minutes; hourly memory sampling suggests a smaller size |
